...
???+ note "不要一味地避免 overlap"

    具体来说，我们要优先选择基本主蕴含项，从而避免 overlap，这一点没什么问题；但是选择完基本主蕴含项后，选择非基本主蕴含项的时候请摒弃你那减少 overlap 的观点（因为这个观点已经通过“先选基本主蕴含项，后选非基本主蕴含项”实现了），千万不要为了减少 overlap 而在这一步选择了面积不充分大的非极大蕴含项（非主蕴含项）。
